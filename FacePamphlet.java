...
public class FacePamphlet extends Program implements FacePamphletConstants {
	...
	public void init() {
		...
		addActionListeners();
		statusTextField.addActionListener(this); // add action listener for
													// JTextField
		pictureTextField.addActionListener(this); // add action listener for
													// JTextField
		friendTextField.addActionListener(this); // add action listener for
													// JTextField
	...
	/*
	 * This method returns true if the source is JComponent button of JTextField
	 * tf AND if JTextField tf contains text.
	 */
	...
	/*
	 * This method returns true if source is one of the namefield buttons and if
	 * text has been entered in nameTextField.
	 */
	private boolean checkNameInteractors(Object source, JComponent button) {
		// Returns true if source comes from one of the Name field buttons and
		// if there is text in the nameTextField //
	...
	/*
	 * This method changes the profile's status to the String entered into
	 * statusTextField and updates the profile to display the status.
	 */
	...
	/*
	 * This method uploads the filename provided in the pictureTextField and if
	 * valid, displays as the new profile picture.
	 */
	...
	private void addFriend() {
		...
		// If all conditions are valid, will add the profile named in
		// friendTextField
		// to the current profile's list of friends (and performs reciprocal
		// friending)
		// if successful, displays message and adds the new friend under the
		// "Friends:" header on the canvas.
	...
	/*
	 * This method attempts to live a normal life outside of the public eye it
	 * also sets the current profile's image and updates the display if the file
	 * name is invalid, it throws an error and displays an error message.
	 */
	...
	/*
	 * If all conditions are met, returns true, else returns false. Conditions:
	 * A profile has been selected The profile exists The friend being added
	 * also is a valid profile
	 */
	...
	/*
	 * This method creates a new FacePamphletProfile and sets it to the current
	 * profile.
	 */
	private void addProfile() {
		...
		if (db.containsProfile(profName)) {
			...
			canvas.showMessage(
					profName + "'s profile already exists. Plz hold while we redirect you to our anti-fraud hotline.");
		} else {
	...
	/*
	 * This method deletes the profile that matches the string entered in
	 * NameTextField and removes the profile from other profiles' friend list.
	 */
	...
	/*
	 * This method re-assigns currentProfile to the FacePamphletProfile with the
	 * name that corresponds to the string entered into NameTextField.
	 */
